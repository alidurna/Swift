...
// Framework adında bir yapı oluşturuyoruz ve Hashable, Identifiable protokollerini uyguluyoruz.
struct Framework: Hashable, Identifiable {
    
    // UUID ile benzersiz bir kimlik oluşturuyoruz.
    let id = UUID()
    
    // Çerçevenin adını, resim adını, URL'sini ve açıklamasını içeren özellikler.
    let name: String
...
// MockData adında bir yapı oluşturuyoruz.
struct MockData {
    
    // Örnek bir çerçeve oluşturuyoruz.
    ...
    // Bir dizi çerçeve içeren örnek veriler.
